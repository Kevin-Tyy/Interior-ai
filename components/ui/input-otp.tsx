...
const InputOTPGroup = React.forwardRef<React.ElementRef<"div">, React.ComponentPropsWithoutRef<"div">>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("flex items-center gap-2 mx-auto", className)} {...props} />
));
  ...
  ({ index, className, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "relative flex h-14 w-14 items-center justify-center border border-white transition-all rounded-lg text-white text-xl",
